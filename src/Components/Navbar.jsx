...
export default function Navbar() {
  ...
  return (
    <div className="navbar bg-gray-100  px-6 md:px-8 shadow-md sticky top-0 z-40">
      <div className="navbar-start">
          <div className="dropdown">
            ...
            <Link href="/" className="flex items-center gap-2"> <h1 className="text-[1.3rem] font-bold"> Next<span className="text-gradient">Shop</span> </h1>   </Link>
      </div>
